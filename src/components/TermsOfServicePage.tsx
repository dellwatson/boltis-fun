      ...
      >
        ...
        <motion.div className="flex items-center gap-4 mb-8" variants={itemVariants}>
          ...
          <div>
            ...
            <p className="text-white/80">Rules and guidelines for using BOLTIS</p>
          </div>
        </motion.div>
          ...
          <div className="prose prose-lg max-w-none text-white">
            <div className="mb-8">
              ...
              <p className="text-white/80 mt-4">
                Welcome to BOLTIS! These Terms of Service ("Terms") govern your use of our game and services. 
                By accessing or using BOLTIS, you agree to be bound by these Terms.
              </p>
            </div>
            ...
            <div className="space-y-8">
              ...
              <section>
                ...
                <div className="text-white/90 space-y-3">
                  <p>
                    By creating an account, playing BOLTIS, or using any of our services, you acknowledge that you have read, 
              ...
              <section>
                ...
                <div className="text-white/90 space-y-3">
                  ...
                  <p>
                    If you are under 18, you represent that you have your parent or guardian's permission to use our services.
                  </p>
                </div>
              </section>
              ...
              <section>
                <h2 className="text-2xl font-bold text-white mb-4">Game Rules and Fair Play</h2>
                <div className="text-white/90 space-y-3">
                  <p>BOLTIS is committed to providing a fair and enjoyable gaming experience:</p>
                  <ul className="list-disc list-inside space-y-2 ml-4">
                  ...
                  <p className="mt-4">
                    We reserve the right to investigate and take action against players who violate fair play principles, 
              ...
              <section>
                ...
                <div className="text-white/90 space-y-3">
                  <p>
                    BOLTIS and all related content, including but not limited to graphics, text, software, and game mechanics, 
                  ...
                  <p className="mt-4">
                    <strong>Proprietary Game Mechanics:</strong> Certain game mechanics including Void Card effects, 
                    Elemental Stacking system, and other unique gameplay elements are proprietary intellectual property 
                    of Dale Watson and Theras Labs, Inc.
                  </p>
                </div>
              </section>
              ...
              <section>
                ...
                <div className="text-white/90 space-y-3">
                  <p>
                    BOLTIS is provided "as is" without warranties of any kind. We do not guarantee that our services will be:
                  </p>
                  <ul className="list-disc list-inside space-y-2 ml-4">
              ...
              <section>
                ...
                <div className="text-white/90 space-y-3">
                  <p>
                    ...
                    consequential, or punitive damages arising from your use of BOLTIS.
                  </p>
                  <p>
                    Our total liability to you for any claims related to these Terms or our services shall not exceed 
              ...
              <section>
                ...
                <div className="text-white/90 space-y-3">
                  ...
                  <p className="mt-4">
                    You may terminate your account at any time by contacting us or using account deletion features in the game.
                  </p>
                </div>
              </section>
              ...
              <section>
                ...
                <div className="text-white/90">
                  <p>
                    ...
                    the updated Terms on our website or in the game. Your continued use of our services after such 
              ...
              <section>
                ...
                <div className="text-white/90">
                  <p>
                    ...
                    in the courts of Bali, Indonesia.
                  </p>
                </div>
              </section>
              ...
              <section className="bg-white/5 p-6 rounded-xl border border-white/20">
                ...
                <div className="text-white/90 space-y-2">
                  ...
                  <div className="space-y-1">
                    <p><strong>Email:</strong> legal@theras.xyz</p>
