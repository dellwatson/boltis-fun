...
import { ArrowLeft, Mail, MessageSquare, Phone, MapPin, Send, CheckCircle, Twitter, Github, MessageCircle } from 'lucide-react';
          ...
          <div className="space-y-6">
              ...
              <div className="space-y-6">
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-white/80">support@boltis.game</p>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-white/60 text-sm">Building the future of card games</p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-white/60 text-sm">Chat with players and developers</p>
                  </div>
                </div>
              </div>
            </motion.div>
            ...
            >
              ...
              <div className="grid grid-cols-1 gap-4">
                <motion.a
                  href="https://twitter.com/boltis_game"
                  target="_blank"
                ...
                >
                  ...
                  <div>
                    ...
                    <div className="text-white/60 text-sm">@boltis_game</div>
                  </div>
                </motion.a>

                <motion.a
                  href="https://github.com/boltis-game"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center gap-4 p-4 bg-white/5 rounded-lg hover:bg-white/10 transition-colors"
                  whileHover={{ scale: 1.02 }}
                ...
                >
                  ...
                  <div>
                    ...
                    <div className="text-white/60 text-sm">Open source project</div>
                  </div>
                </motion.a>

                <motion.a
                  href="https://discord.gg/boltis"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center gap-4 p-4 bg-white/5 rounded-lg hover:bg-white/10 transition-colors"
                  whileHover={{ scale: 1.02 }}
            ...
            >
              ...
              <div className="space-y-4">
                <div>
                  <h3 className="font-semibold text-white mb-2">🎮 How do I play BOLTIS?</h3>
                  <p className="text-white/80 text-sm">Check out our How to Play section on the homepage for complete rules and strategies.</p>
                </div>
                
                <div>
                  <h3 className="font-semibold text-white mb-2">🐛 Found a bug?</h3>
                  <p className="text-white/80 text-sm">Use the feedback widget in the bottom-left corner or email us with details.</p>
                </div>
                
                <div>
                  <h3 className="font-semibold text-white mb-2">💡 Have a feature idea?</h3>
                  <p className="text-white/80 text-sm">We'd love to hear it! Send us your suggestions through this contact form.</p>
                </div>
                
                <div>
                  <h3 className="font-semibold text-white mb-2">🏆 Want to compete?</h3>
                  <p className="text-white/80 text-sm">Join our leaderboards and participate in community tournaments.</p>
                </div>
              </div>
            </motion.div>
          </div>
